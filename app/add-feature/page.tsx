...
export default function AddFeaturePage() {
  ...
  return (
    <div className="mx-auto max-w-2xl space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-slate-900">Add Feature</h1>
        <p className="text-slate-600">Create a new product feature or BRD entry</p>
      </div>
      ...
      >
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          ...
          <div>
            <label className="mb-1 block text-sm font-medium text-slate-700">Request Date</label>
          ...
          <div>
            <label className="mb-1 block text-sm font-medium text-slate-700">BRD Shared Date</label>
          ...
          <div>
            <label className="mb-1 block text-sm font-medium text-slate-700">Development Start</label>
          ...
          <div>
            ...
            <input type="text" value={form.release_version} onChange={(e) => update("release_version", e.target.value)} placeholder="v2.1.0" className="w-full rounded-lg border border-slate-300 bg-white px-3 py-2 text-slate-900" />
          </div>
          <div>
          ...
          <div className="flex items-center gap-2 sm:col-span-2">
            <input type="checkbox" id="scope_changed" checked={form.scope_changed_after_release} onChange={(e) => update("scope_changed_after_release", e.target.checked)} className="h-4 w-4 rounded border-slate-300" />
            <label htmlFor="scope_changed" className="text-sm font-medium text-slate-700">Scope changed after release</label>
          </div>
          <div className="sm:col-span-2">
        ...
        <div className="flex gap-4">
          <button type="submit" disabled={submitting} className="rounded-lg bg-slate-900 px-6 py-2.5 font-medium text-white hover:bg-slate-800 disabled:opacity-50">
            {submitting ? "Saving..." : "Save Feature"}
          </button>
          <button type="button" onClick={() => router.push("/features")} className="rounded-lg border border-slate-300 px-6 py-2.5 font-medium text-slate-700 hover:bg-slate-50">
            Cancel
          </button>
        </div>
      </form>
